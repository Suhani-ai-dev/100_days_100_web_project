...
export default function HangmanSVG({ wrongCount }: Props) {
  // Each part has a CSS class that transitions opacity/transform
  return (
    <svg
      viewBox="0 0 200 240"
    ...
    >
      {/* Gallows */}
      <g className="gallows">
        <rect x="10" y="220" width="180" height="10" fill="#333" />
        <rect x="30" y="20" width="10" height="200" fill="#333" />
        <rect x="30" y="20" width="100" height="10" fill="#333" />
        <rect x="130" y="20" width="2" height="30" fill="#333" />
      </g>
