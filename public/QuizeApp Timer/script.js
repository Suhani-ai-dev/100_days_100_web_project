  ...
  science: {
    ...
    questions: [
      ...
      },
      {
        ...
        correct: 1,
        explanation:
          "Water's chemical formula is H2O, representing two hydrogen atoms and one oxygen atom.",
      },
      {
      ...
      },
      {
        ...
        correct: 1,
        explanation:
          "Saturn has the most known moons, with over 80 confirmed satellites.",
      },
      {
  ...
  history: {
    ...
    questions: [
      ...
      },
      {
        ...
        correct: 0,
        explanation:
          "Marie Curie was the first woman to win a Nobel Prize, winning in Physics in 1903.",
      },
      {
      ...
      },
      {
        ...
        correct: 2,
        explanation:
          "The American Civil War ended in 1865 with the surrender of Confederate forces.",
      },
      {
        ...
        correct: 0,
        explanation:
          "Qin Shi Huang unified China and became its first Emperor in 221 BCE.",
      },
      {
        ...
        correct: 1,
        explanation:
          "Norway, led by Roald Amundsen, reached the South Pole first in 1911.",
      },
    ],
  },
  tech: {
    ...
    questions: [
      ...
      },
      {
        ...
        correct: 0,
        explanation:
          "CPU stands for Central Processing Unit, the primary processor of a computer.",
      },
      {
      ...
      },
      {
        ...
        correct: 1,
        explanation:
          "RAM (Random Access Memory) provides temporary storage for data that's actively being used.",
      },
      {
      ...
      },
      {
        ...
        correct: 2,
        explanation:
          "C is often called the 'mother of all languages' as many modern languages are influenced by it.",
      },
      {
