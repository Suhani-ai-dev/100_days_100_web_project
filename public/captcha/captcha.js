...
const addDifficultySelector = () => {
  ...
  const buttonSection =
    document.querySelector(".button") || captchaContainer.parentNode;
    ...
    case "image":
      ...
      captchaContainer.querySelectorAll(".image-option").forEach((option) => {
        option.addEventListener("click", () => {
          ...
          selectedImageAnswer = images.find(
    ...
    case "audio":
      ...
      playButton.addEventListener("click", async () => {
        ...
        try {
          ...
          alert(
            "Audio playback failed. Please try again or use a different CAPTCHA type.",
          );
        } finally {
