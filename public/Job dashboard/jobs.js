...
function filterJobs() {
  ...
  const jobs = [
    ...
    },
    {
      ...
      shift: "fixed shift",
      image:
        "https://static.vecteezy.com/system/resources/previews/001/198/090/non_2x/world-png.png",
      link: "ITWorlds.html",
    },
    {
      ...
      shift: "flexible shift",
      image:
        "https://th.bing.com/th/id/OIP.iJbuiX_YdBeTqI7wYawlwwHaHa?rs=1&pid=ImgDetMain",
...
function filterBySalary(jobSalary, filterSalary) {
  ...
  if (filterSalary.includes("-")) {
    const [filterMin, filterMax] = filterSalary
      .split("-")
