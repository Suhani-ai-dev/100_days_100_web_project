...
function changeMode() {
  if (currmode == "light") {
    ...
    if (window.matchMedia("(max-width:1098px)").matches) {
      document.querySelector(".image").style.background =
        "linear-gradient(#9ad7ff 0%, #fecfef 99%, #fecfef 100%)";
    }
...
modeBtn.addEventListener("click", () => {
  ...
  if (darkMode) {
    ...
    document.querySelector(".navbar").style.borderBottom = "1px solid #374151";
    document.querySelector(".logo h2").style.color = "#ffffff";
    document.querySelector(".logo p").style.color = "#d1d5db";
    document.querySelector(".theme-section span").style.color = "#ffffff";
  ...
  // LIGHT MODE
    ...
    document.querySelector(".navbar").style.borderBottom = "1px solid #ececec";
    document.querySelector(".logo h2").style.color = "#111827";
    document.querySelector(".logo p").style.color = "#6b7280";
    document.querySelector(".theme-section span").style.color = "#374151";
...
saveBtn.addEventListener("click", () => {
  cardName.textContent = nameInput.value || "Krishna Bhati";
  cardRole.textContent = roleInput.value || "Ui/Ux Designer";
  cardBio.textContent =
    bioInput.value || "Hardworking and reliable UI/UX designer.";
