...
async function calculateProfit() {
  ...
  const buyCommission = parseFloat(
  ...
  const annualizedReturn =
    (Math.pow(1 + profitAmount / purchasedFor, 365 / holdingPeriod) - 1) * 100;

  // Update currency symbols
  document.getElementById("currencySymbol1").innerText =
    currencySymbols[currency];
  document.getElementById("currencySymbol2").innerText =
    currencySymbols[currency];
  document.getElementById("currencySymbol3").innerText =
    currencySymbols[currency];
  ...
  document.getElementById("annualizedReturn").innerText =
